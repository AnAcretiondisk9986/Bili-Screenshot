...
1. **获取源码**：
   - 在 [GitHub 仓库](https://github.com/AnAcretiondisk9986/Bili-Screenshot) 页面点击绿色 **Code** 按钮 → **Download ZIP**（或直接到 [Releases](https://github.com/AnAcretiondisk9986/Bili-Screenshot/releases) 下载 `bili-screenshot-1.1.4.zip`）
...
5. 完成！打开任意 B 站视频页，按 `Ctrl+Shift+Q` 即可截图
...
- **一键静默截图**：快捷键直接保存，默认 `Ctrl+Shift+Q`（Mac：`Ctrl+Shift+Q`）
...
| 操作 | 默认快捷键 | 在哪改 |
| --- | --- | --- |
| 单张截图 | `Ctrl+Shift+Q` / `Ctrl+Shift+Q` | 扩展**设置页**（页面内快捷键）或 `chrome://extensions/shortcuts`（系统级） |
